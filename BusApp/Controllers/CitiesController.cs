...
namespace BusApp.Controllers
{
    public class CitiesController : Controller
    {
        ...
        [Authorize]
        public ActionResult Create([Bind(Include = "ID,ProvinceID,CountryID,Name")] City city)
        {
            ...
            ViewBag.ProvinceID = new SelectList(db.Provinces, "ID", "Name", city.ProvinceID);
            return View(city);
        }
        ...
        [ValidateAntiForgeryToken]
        [Authorize]
        public ActionResult Edit([Bind(Include = "ID,ProvinceID,CountryID,Name")] City city)
        {
            if (ModelState.IsValid)
            {
